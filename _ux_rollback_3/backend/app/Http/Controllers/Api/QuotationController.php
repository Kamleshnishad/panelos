...
class QuotationController extends Controller
{
    ...
    public function getSuggestedRate(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'density_type'       => 'nullable|in:PUF,PIR',
    ...
    private function quotationRules(int $companyId, bool $update = false): array
    {
        ...
        return [
            ...
            'panel_rows.*.thickness'                => 'required|integer|in:30,40,50,60,75,80,100,120,150,200',
            'panel_rows.*.density_type'             => 'required|in:PUF,PIR',
            'panel_rows.*.density_kgm3'             => 'required|numeric|in:38,40,42,48',
