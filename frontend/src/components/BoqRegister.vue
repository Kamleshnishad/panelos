    ...
    <div class="table-wrap">
      ...
      <table v-else>
        ...
        <tbody>
          ...
          <tr v-for="row in rows" :key="row.id" class="clickable" tabindex="0" role="button" :aria-label="'Edit ' + row.quotation_no" @click="$emit('edit', row.id)" @keyup.enter="$emit('edit', row.id)">
