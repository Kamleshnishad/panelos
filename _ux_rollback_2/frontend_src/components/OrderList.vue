  ...
  <div class="order-list">
    ...
    <div class="table-wrap">
      ...
      <table v-else>
        <thead>
          <tr>
            <th @click="sortBy('order_no')" class="sortable">Order No</th>
            <th @click="sortBy('order_date')" class="sortable">Date</th>
            <th>Customer</th>
            <th>Project</th>
            <th class="text-right">Total SQM</th>
            <th class="text-right sortable" @click="sortBy('total_amount')">Amount</th>
            <th>Delivery</th>
            <th>Status</th>
            <th>Batches</th>
          </tr>
